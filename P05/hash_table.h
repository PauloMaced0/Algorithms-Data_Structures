...
// * the value is of type T (use a #define or a typedef to define it before including this file) DONE!
...
static hash_table_node *free_hash_table_nodes = NULL; // linked list of free hash table nodes
static unsigned int hash_table_size = 0u;
static hash_table_node **hash_table = NULL;
...
{
  unsigned int hash = hash_function(n->key);
